# Inference Sheet: household (Rank 2)
**Grouping**: Low(<25%) vs High(>75%)
**Subset**: Education level=Post-Graduate Education
**Metrics**: AUC=0.72, KNN=0.57, CentroidDist=0.09
...
- There is an association between the axes and the grouping variable (AUC = 0.72).
...
> **Correct Answer**: B
> *Rationale*: The KNN purity of 0.57 indicates overlap, but AUC 0.72 suggests signal.
