# Inference Sheet: Expanded Disability Status Scale (Rank 1)
**Grouping**: Low(<25%) vs High(>75%)
**Subset**: Residence=Edinburgh
**Metrics**: AUC=0.68, KNN=0.64, CentroidDist=0.08
...
- There is an association between the axes and the grouping variable (AUC = 0.68).
...
> **Correct Answer**: B
> *Rationale*: The KNN purity of 0.64 indicates overlap, but AUC 0.68 suggests signal.
