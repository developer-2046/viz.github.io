# Inference Sheet: rxmeds_number (Rank 9)
**Grouping**: Low(<25%) vs High(>75%)
**Subset**: treatments=Untreated
**Metrics**: AUC=0.74, KNN=0.57, CentroidDist=0.10
...
- There is an association between the axes and the grouping variable (AUC = 0.74).
...
> **Correct Answer**: B
> *Rationale*: The KNN purity of 0.57 indicates overlap, but AUC 0.74 suggests signal.
